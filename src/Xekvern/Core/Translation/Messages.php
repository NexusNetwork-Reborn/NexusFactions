...
interface Messages {
    ...
    const MESSAGE = [
        ...
        "notReachedGoal" => self::RED . "This feature has not yet reached its fund goal. Use the command /fund to help reach its goal!",
        ...
        "activeCoinFlip" => self::RED . "You have an active coinflip! ",
        ...
        "addAuctionEntry" => self::GREEN . "You have listed an auction for {item} for {price}!",
        "buyAuction" => self::PURPLE . "{name} has bought {item} for {amount}!",
        "addCoinFlip" => self::GREEN . "You have added a coin flip queue. Waiting for an opponent to /coinflip",
        ...
        "maxRank" => self::RED . "You have already reached the maximum possible rank!",
        ...
        "messageCooldown" => self::RED . "You are messaging too fast! You can message again for {amount} seconds!",
        ...
        "notEnoughMoneyRankUp" => self::RED . "You don't have enough money to rankup! You need {amount} in total!",
        ...
        "LuckyBlockToggleChange" => self::GREEN . "You've turned {mode} your lucky blocks.",
